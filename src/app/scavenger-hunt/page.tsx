...
export default function ScavengerHuntPage() {
  ...
  const handleBackToWorkspace = () => {
    router.push('/scavenger-hunt-main')
  }
  ...
  return (
    <div
      className="flex min-h-screen flex-col px-3 pb-6 pt-0 text-slate-900 sm:px-4 lg:px-6"
      style={pageBackgroundStyle}
    >
      <div className="mx-auto flex w-full max-w-none flex-1 flex-col gap-4">
        <WorkspaceHeader
